...
/*
    Exercise 1: The variable middle is not necesarrily an interger, that depends on how the array is defined. If the
                array is defined as a character, the computer might see those variables in that manner.
    Exercise 2: It found 19 in position 2 and 12 in position 8. It found the first instance of 19 because that was the
                first number it came across after searching the first half. It found the second instance of 12 because
                that was in the very middle, and thus did not need to search any further.
